...
\significancestatement{
    ...
    Many symbiotic microbes benefit hosts under harsh environments.
	Similar to harsh average conditions, environmental variability is predicted to have negative consequences for species' population growth rates. 
	We report a 14-year demographic analysis of the experimental removal of fungal symbionts from seven plant species and demonstrate for the first time that symbionts buffer their hosts from environmental variability.
	Host life history (i.e. species' longevity) predicts the magnitude of variance buffering effects.
	In simulations, increased environmental variability intensified benefits from variance buffering.
	This strengthening suggests that symbionts may provide resilience to future increases in environmental variability, a key prediction of global climate change.
