...
\significancestatement{
	...
	\textbf{limit = 120 words}
    Symbiotic microbes protect many organisms from environmental stress.
	Demographic theory predicts that environmental variability has negative consequences for species' population growth rates. 
	We report a 14-year demographic analysis of the removal of fungal symbionts from seven plant species. 
	We demonstrate for the first time that symbionts buffer their hosts from environmental variability.
	Host life history (i.e. species' longevity) predicts the magnitude of variance buffering effects.
	Benefits from variance buffering increase in simulations of increased environmental variability.
	This strengthening of the mutualism suggests that symbionts may provide resilience to future increases in environmental variability, a key prediction of global climate change.
	Our study therefore has implications for both life history theory and for forecasting species' responses to stochastic global change.
}
