...
%you have to run once with the table of contents to populate the toc file, and then compile a second time with the main TOC commented out to have just appendix TOC
%\tableofcontents
\begin{comment}
{\tableofcontents}
\end{comment}
