...
Global climate change involves heterogenous changes in environmental variability, including an increasing frequency of extreme weather events and of ``whiplash events'' that alternate between climate extremes \cite{seneviratne2012changes, bathiany2018climate,swain2018increasing,ipcc_2021}.
...
Incorporating realistic variability into forecasts of population dynamics can improve predictive ability \cite{clark2005environmental}.
...
Yet, little is known about how inter-specific interactions contribute to demographic buffering \cite{hilde_demographic_2020}. 
...
The exceptions were \emph{P. sylvestris} and \emph{A. perennans}, for which our analysis indicated effectively neutral symbionts in their overall fitness effect (42\% and 57\% posterior probability of positive effects respectively; Fig. S71). 
...
However, the strongest symbiotic benefits derived from the combination of both mean effects and variance buffering (Fig. 1B), and simulation experiments point to an increasing role for demographic buffering under increased temporal environmental stochasticity (Fig. S81-S82).
There is growing interest in demographic buffering as a potential source of resilience against increased stochasticity under global change \cite{hilde_demographic_2020}. 
...
In fact, any interaction that is subject to context-dependence -- where the magnitude of cost or benefit depends on harshness of the environment -- holds potential to modify demographic variance across years. 
...
The host species for which the net mutualism benefit was greatest (\emph{F. subverticillata} and \emph{L. arundinaceum}) (Fig. S81) were among those never observed to produce fungal stromata (Table S2), supporting theoretical expectations that strict vertical transmission drives evolution of strong host-symbiont mutualism \cite{fine1975vectors,afkhami2008symbiosis}. 
We caution that inferences on trait correlates of demographic buffering were subject to large uncertainties (Fig. S83-S84), reflecting relatively narrow taxonomic breadth (closely related grass species in the sub-family Pooidae and their co-evolving symbionts).
...
\bmhead{Supplementary information} Supplementary information for this paper includes Supplementary Methods, Figs. S1 to S89, and Tables S1 to S3. 



\bibliography{EndoStochDemo-test}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width=.6\linewidth]{recruit_surv_meanplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on mean adult survival - Recruits]{Effect of endophyte symbiosis on mean adult survival. Fitted curves represent the size-specific mean survival probability for recruited plants along with data binned by size and averaged over many individuals, years, and plots shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. 80\% credible intervals are shown with dark shading for  S+, or light shading for S-.}
\end{myfigure}


\begin{myfigure}[H]
	\centering
	\includegraphics[width=.6\linewidth]{grow_meanplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on mean adult growth - Original]{Effect of endophyte symbiosis on mean adult growth. Fitted curves represent the size-specific mean expected plant size for originally transplanted plants along with data binned by size and averaged over many individuals, years, and plots shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. 80\% credible intervals are shown with dark shading for  S+, or light shading for S-.}
\end{myfigure}

\begin{myfigure}[H]
	\centering
	\includegraphics[width=.6\linewidth]{recruit_grow_meanplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on mean adult growth - Recruits]{Effect of endophyte symbiosis on mean adult growth. Fitted curves represent the size-specific mean expected plant size for recruited plants along with data binned by size and averaged over many individuals, years, and plots shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. 80\% credible intervals are shown with dark shading for  S+, or light shading for S-.}
\end{myfigure}

\begin{myfigure}[H]
	\centering
	\includegraphics[width=.6\linewidth]{flw_meanplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on mean flowering - Original]{Effect of endophyte symbiosis on mean flowering. Fitted curves represent the size-specific mean flowering probability for originally transplanted plants along with data binned by size and averaged over many individuals, years, and plots shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. 80\% credible intervals are shown with dark shading for  S+, or light shading for S-.}
\end{myfigure}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width=.6\linewidth]{recruit_flw_meanplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on mean flowering - Recruits]{Effect of endophyte symbiosis on mean flowering. Fitted curves represent the size-specific mean flowering probability for recruited plants along with data binned by size and averaged over many individuals, years, and plots shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. 80\% credible intervals are shown with dark shading for  S+, or light shading for S-.}
\end{myfigure}


\begin{myfigure}[H]
	\centering
	\includegraphics[width=.6\linewidth]{fert_meanplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on mean fertility - Original]{Effect of endophyte symbiosis on mean fertility. Fitted curves represent the size-specific mean expected number of flowering tillers for originally transplanted plants along with data binned by size and averaged over many individuals, years, and plots shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. 80\% credible intervals are shown with dark shading for  S+, or light shading for S-.}
\end{myfigure}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width=.6\linewidth]{recruit_fert_meanplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on mean fertility - Recruits]{Effect of endophyte symbiosis on mean fertility. Fitted curves represent the size-specific mean expected number of flowering tillers for recruited plants along with data binned by size and averaged over many individuals, years, and plots shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. 80\% credible intervals are shown with dark shading for  S+, or light shading for S-.}
\end{myfigure}


\begin{myfigure}[H]
	\centering
	\includegraphics[width=.6\linewidth]{spike_meanplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on mean spikelet production - Original]{Effect of endophyte symbiosis on mean spikelet production. Fitted curves represent the size-specific mean expected number of spikelets per inflorescence for originally transplanted plants along with data binned by size and averaged over many individuals, years, and plots shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. 80\% credible intervals are shown with dark shading for  S+, or light shading for S-.}
\end{myfigure}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width=.6\linewidth]{recruit_spike_meanplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on mean spikelet production - Recruits]{Effect of endophyte symbiosis on mean spikelet production. Fitted curves represent the size-specific mean expected number of spikelets per inflorescence for recruited plants along with data binned by size and averaged over many individuals, years, and plots shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. 80\% credible intervals are shown with dark shading for  S+, or light shading for S-.}
\end{myfigure}


\begin{myfigure}[H]
	\centering
	\includegraphics[width=\linewidth]{surv_yearplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on yearly adult survival - Original]{Effect of endophyte symbiosis on yearly adult survival. Fitted curves represent the size-specific annual survival probability for originally transplanted plants along with data binned by size and census year and averaged over many individuals, and plots shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. }
\end{myfigure}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width=\linewidth]{recruit_surv_yearplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on yearly adult survival - Recruits]{Effect of endophyte symbiosis on yearly adult survival. Fitted curves represent the size-specific annual survival probability for recruited plants along with data binned by size and census year and averaged over many individuals, and plots  shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. }
\end{myfigure}


\begin{myfigure}[H]
	\centering
	\includegraphics[width=\linewidth]{grow_yearplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on yearly adult growth - Original]{Effect of endophyte symbiosis on yearly adult growth. Fitted curves represent the size-specific annual expected plant size for originally transplanted plants along with data binned by size and census year and averaged over many individuals, and plots  shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. }
\end{myfigure}


\begin{myfigure}[H]
	\centering
	\includegraphics[width=\linewidth]{recruit_grow_yearplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on yearly adult growth - Recruits]{Effect of endophyte symbiosis on yearly adult growth. Fitted curves represent the size-specific annual expected plant size for recruited plants along with data binned by size and census year and averaged over many individuals, and plots  shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants. }
\end{myfigure}

\begin{myfigure}[H]
	\centering
	\includegraphics[width=\linewidth]{flw_yearplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on yearly flowering - Original]{Effect of endophyte symbiosis on yearly flowering. Fitted curves represent the size-specific annual flowering probability for originally transplanted plants along with data binned by size and census year and averaged over many individuals, and plots  shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants.}
\end{myfigure}


\begin{myfigure}[H]
	\centering
	\includegraphics[width=\linewidth]{recruit_flw_yearplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on yearly flowering - Recruits]{Effect of endophyte symbiosis on yearly flowering. Fitted curves represent the size-specific annual flowering probability for recruited plants along with data binned by size and census year and averaged over many individuals, and plots  shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants.}
\end{myfigure}


\begin{myfigure}[H]
	\centering
	\includegraphics[width=\linewidth]{fert_yearplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on yearly fertility - Original]{Effect of endophyte symbiosis on yearly fertility. Fitted curves represent the size-specific annual expected number of flowering tillers for originally transplanted plants along with data binned by size and census year and averaged over many individuals, and plots  shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants.}
\end{myfigure}


\begin{myfigure}[H]
	\centering
	\includegraphics[width=\linewidth]{recruit_fert_yearplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on yearly fertility - Recruits]{Effect of endophyte symbiosis on yearly fertility. Fitted curves represent the size-specific annual expected number of flowering tillers for recruited plants along with data binned by size and census year and averaged over many individuals, and plots  shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants.}
\end{myfigure}


\begin{myfigure}[H]
	\centering
	\includegraphics[width=\linewidth]{spike_yearplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on yearly spikelet production - Original]{Effect of endophyte symbiosis on yearly spikelet production. Fitted curves represent the size-specific annual expected number of spikelets per inflorescence for originally transplanted plants along with data binned by size and census year and averaged over many individuals, and plots  shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants.}
\end{myfigure}


\begin{myfigure}[H]
	\centering
	\includegraphics[width=\linewidth]{recruit_spike_yearplot_quadXorigin.png}
	\caption[Effect of endophyte symbiosis on yearly spikelet production - Recruits]{Effect of endophyte symbiosis on yearly spikelet production. Fitted curves represent the size-specific annual expected number of spikelets per inflorescence for recruited plants along with data binned by size and census year and averaged over many individuals, and plots shown as open circles with a dashed line for symbiont-free (S-) plants, while the solid line and filled circles represent symbiontic (S+) plants.}
\end{myfigure}


\begin{myfigure}[H]
	\centering
	\includegraphics[width=.9\linewidth]{surv_sigmayear_hist_quadXorigin.png}
	\caption[Posterior distributions of the standard deviations of inter-annual year effects for survival]{Posterior distributions of the standard deviations of inter-annual year effects for survival. Histograms include 7500 post-warmup MCMC samples for symbiotic (S+; blue) and symbiont-free (S-; tan) plants from fitted vital rate model.}
\end{myfigure}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width=.9\linewidth]{grow_sigmayear_hist_quadXorigin.png}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width=.9\linewidth]{flow_sigmayear_hist_quadXorigin.png}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width=.9\linewidth]{fert_sigmayear_hist_quadXorigin.png}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width=.9\linewidth]{spike_sigmayear_hist_quadXorigin.png}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{AGPE_growth_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{A. perennans} growth model across size]{Graphical posterior predictive check for mean and higher moments of \emph{A. perennans} growth model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}

\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{ELRI_growth_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{E. villosus} growth model across size]{Graphical posterior predictive check for mean and higher moments of \emph{E. villosus} growth model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{ELVI_growth_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{E. virginicus} growth model across size]{Graphical posterior predictive check for mean and higher moments of \emph{E. virginicus} growth model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{FESU_growth_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{F. subverticillata} growth model across size]{Graphical posterior predictive check for mean and higher moments of \emph{F. subverticillata} growth model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{LOAR_growth_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{L. arundinacea} growth model across size]{Graphical posterior predictive check for mean and higher moments of \emph{L. arundinacea} growth model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{POAL_growth_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{P. alsodes} growth model across size]{Graphical posterior predictive check for mean and higher moments of \emph{P. alsodes} growth model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{POSY_growth_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{P. sylvestris} growth model across size]{Graphical posterior predictive check for mean and higher moments of \emph{P. sylvestris} growth model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{AGPE_surv_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{A. perennans} survival model across size]{Graphical posterior predictive check for mean and higher moments of \emph{A. perennans} survival model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}

\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{ELRI_surv_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{E. villosus} survival model across size]{Graphical posterior predictive check for mean and higher moments of \emph{E. villosus} survival model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{ELVI_surv_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{E. virginicus} survival model across size]{Graphical posterior predictive check for mean and higher moments of \emph{E. virginicus} survival model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{FESU_surv_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{F. subverticillata} survival model across size]{Graphical posterior predictive check for mean and higher moments of \emph{F. subverticillata} survival model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{LOAR_surv_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{L. arundinacea} survival model across size]{Graphical posterior predictive check for mean and higher moments of \emph{L. arundinacea} survival model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{POAL_surv_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{P. alsodes} survival model across size]{Graphical posterior predictive check for mean and higher moments of \emph{P. alsodes} survival model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{POSY_surv_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{P. sylvestris} survival model across size]{Graphical posterior predictive check for mean and higher moments of \emph{P. sylvestris} survival model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{AGPE_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{A. perennans} inflorescence production model across size]{Graphical posterior predictive check for mean and higher moments of \emph{A. perennans} inflorescence production model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}

\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{ELRI_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{E. villosus} inflorescence production model across size]{Graphical posterior predictive check for mean and higher moments of \emph{E. villosus} inflorescence production model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{ELVI_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{E. virginicus} inflorescence production model across size]{Graphical posterior predictive check for mean and higher moments of \emph{E. virginicus} inflorescence production model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{FESU_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{F. subverticillata} inflorescence production model across size]{Graphical posterior predictive check for mean and higher moments of \emph{F. subverticillata} inflorescence production model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{LOAR_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{L. arundinacea} inflorescence production model across size]{Graphical posterior predictive check for mean and higher moments of \emph{L. arundinacea} inflorescence production model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{POAL_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{P. alsodes} inflorescence production model across size]{Graphical posterior predictive check for mean and higher moments of \emph{P. alsodes} inflorescence production model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{POSY_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{P. sylvestris} inflorescence production model across size]{Graphical posterior predictive check for mean and higher moments of \emph{P. sylvestris} inflorescence production model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{AGPE_spike_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{A. perennans} spikelet model across size]{Graphical posterior predictive check for mean and higher moments of \emph{A. perennans} spikelet model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}

\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{ELRI_spike_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{E. villosus} spikelet model across size]{Graphical posterior predictive check for mean and higher moments of \emph{E. villosus} spikelet model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{ELVI_spike_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{E. virginicus} spikelet model across size]{Graphical posterior predictive check for mean and higher moments of \emph{E. virginicus} spikelet model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{FESU_spike_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{F. subverticillata} spikelet model across size]{Graphical posterior predictive check for mean and higher moments of \emph{F. subverticillata} spikelet model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{LOAR_spike_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{L. arundinacea} spikelet model across size]{Graphical posterior predictive check for mean and higher moments of \emph{L. arundinacea} spikelet model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{POAL_spike_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{P. alsodes} spikelet model across siz]{Graphical posterior predictive check for mean and higher moments of \emph{P. alsodes} spikelet model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{POSY_spike_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{P. sylvestris} spikelet model across size]{Graphical posterior predictive check for mean and higher moments of \emph{P. sylvestris} spikelet model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{AGPE_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{A. perennans} flowering model across size.]{Graphical posterior predictive check for mean and higher moments of \emph{A. perennans} flowering model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}

\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{ELRI_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{E. villosus} flowering model across size]{Graphical posterior predictive check for mean and higher moments of \emph{E. villosus} flowering model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{ELVI_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{E. virginicus} flowering model across size]{Graphical posterior predictive check for mean and higher moments of \emph{E. virginicus} flowering model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{FESU_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{F. subverticillata} flowering model across size]{Graphical posterior predictive check for mean and higher moments of \emph{F. subverticillata} flowering model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{LOAR_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{L. arundinacea} flowering model across size]{Graphical posterior predictive check for mean and higher moments of \emph{L. arundinacea} flowering model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{POAL_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{P. alsodes} flowering model across size]{Graphical posterior predictive check for mean and higher moments of \emph{P. alsodes} flowering model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model. }
\end{myfigure}
\begin{myfigure}[H]
	\centering
	\includegraphics[width = .5\linewidth]{POSY_fert_size_ppc_quadXorigin.png}
	\caption[Graphical posterior predictive check for mean and higher moments of \emph{P. sylvestris} flowering model across size]{Graphical posterior predictive check for mean and higher moments of \emph{P. sylvestris} flowering model across size. Consistency between real data and fitted values across sizes indicates that the vital rate models are accurately capturing size dependence. Points show the value of statistical moments binned across size for the observed data (red circles) compared to the simulated datasets (grey circles) and the median of the simulated values (black circles) generated from 500 posterior draws from the fitted model.}
\end{myfigure}
...
\begin{myfigure}[H]
	...
	\caption[Posterior predictive check for statistical model of Seedling Growth]{Posterior predictive check for statistical model of Seedling Growth. Consistency between real data and simulated values indicates that fitted models describe the data well. Lines show density distributions of observed data (blue line) compared to data simulated from fitted models (tan lines) generated from 500 draws from posterior distributions of model parameters along with the distribution's moments.}
\end{myfigure}
...
\begin{myfigure}[H]
	...
	\caption[Posterior predictive check for statistical model of Mean Seeds/Spikelet]{Posterior predictive check for statistical model of Mean Seeds/Spikelet. Consistency between real data and simulated values indicates that fitted models describe the data well. Lines show density distributions of observed data (blue line) compared to data simulated from fitted models (tan lines) generated from 500 draws from posterior distributions of model parameters along with the distribution's moments.}
\end{myfigure}

\begin{myfigure}[H]
	\centering
	\includegraphics[width = \linewidth]{stosbyspecies_densplot.png}
	\caption[Posterior predictive check for statistical model of Recruitment]{Posterior predictive check for statistical model of Recruitment. Consistency between real data and simulated values indicates that fitted models describe the data well. Lines show density distributions of observed data (blue line) compared to data simulated from fitted models (tan lines) generated from 500 draws from posterior distributions of model parameters along with the distribution's moments.}
\end{myfigure}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width=\linewidth]{lambdaS_plot_quadXorigin.png}
...
\begin{myfigure}[H]
	\centering
	\includegraphics[width=\linewidth]{contributions_obs_plot_quadXorigin.png}
