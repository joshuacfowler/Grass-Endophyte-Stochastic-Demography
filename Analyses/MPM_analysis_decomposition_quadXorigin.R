  ...
  for(e in 1:n_endo){
    for(s in 1:n_spp){
      for(y in 1:years_obs){ # loops 1-13, which samples years 2 (2008-2009) through 14 (2020-2021)
        ...
        lambda_year_obs[y,s,e,i] <- lambda(bigmatrix(make_params_quadXorigin(species=s,
                                                             endo_mean=(e-1),
                                                             endo_var=(e-1),
      ...
      for(yi in 1:n_years_samp){
        lambda_year_samp[yi,s,e,i] <- lambda(bigmatrix(make_params_quadXorigin(species=s,
                                                                  endo_mean=(e-1),
                                                                  endo_var=(e-1),
                                                                  original = 1, # should be =1 to represent recruit
                                                                  draw=post_draws[i],
...
saveRDS(lambda_year_obs, file = paste0(path,"/Model_Runs/MPM_output/lambda_year_obs_quadXorigin.rds"))
# 
saveRDS(lambda_mean_obs, file = paste0(path,"/Model_Runs/MPM_output/lambda_mean_obs_quadXorigin.rds"))
saveRDS(lambda_sd_obs, file = paste0(path,"/Model_Runs/MPM_output/lambda_sd_obs_quadXorigin.rds"))
saveRDS(lambda_cv_obs, file = paste0(path,"/Model_Runs/MPM_output/lambda_cv_obs_quadXorigin.rds"))
# 
...
# reading back in the simulations
 lambda_year_obs <- read_rds(paste0(path,"/Model_Runs/MPM_output/lambda_year_obs_quadXorigin.rds"))
...
# # Saving all of the simulations
saveRDS(lambdaS_obs, file = paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_quadXorigin.rds"))
saveRDS(lambdaS_obs_extreme2, file = paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_extreme2_quadXorigin.rds"))
saveRDS(lambdaS_obs_extreme4, file = paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_extreme4_quadXorigin.rds"))
saveRDS(lambdaS_obs_extreme6, file = paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_extreme6_quadXorigin.rds"))
saveRDS(lambdaS_obs_extreme2_em, file = paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_extreme2_em_quadXorigin.rds"))
saveRDS(lambdaS_obs_extreme4_em, file = paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_extreme4_em_quadXorigin.rds"))
saveRDS(lambdaS_obs_extreme6_em, file = paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_extreme6_em_quadXorigin.rds"))

saveRDS(save_lambda_obs, file = paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_quadXorigin.rds"))
saveRDS(save_lambda_obs_extreme2, file = paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_extreme2_quadXorigin.rds"))
saveRDS(save_lambda_obs_extreme4, file = paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_extreme4_quadXorigin.rds"))
saveRDS(save_lambda_obs_extreme6, file = paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_extreme6_quadXorigin.rds"))
saveRDS(save_lambda_obs_extreme2_em, file = paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_extreme2_em_quadXorigin.rds"))
saveRDS(save_lambda_obs_extreme4_em, file = paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_extreme4_em_quadXorigin.rds"))
saveRDS(save_lambda_obs_extreme6_em, file = paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_extreme6_em_quadXorigin.rds"))
...
lambdaS_obs <- read_rds(paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_quadXorigin.rds"))
lambdaS_obs_extreme2 <- read_rds(paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_extreme2_quadXorigin.rds"))
lambdaS_obs_extreme4 <- read_rds(paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_extreme4_quadXorigin.rds"))
lambdaS_obs_extreme6 <- read_rds(paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_extreme6_quadXorigin.rds"))
lambdaS_obs_extreme2_em <- read_rds(paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_extreme2_em_quadXorigin.rds"))
lambdaS_obs_extreme4_em <- read_rds(paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_extreme4_em_quadXorigin.rds"))
lambdaS_obs_extreme6_em <- read_rds(paste0(path,"/Model_Runs/MPM_output/lambdaS_obs_extreme6_em_quadXorigin.rds"))

save_lambda_obs <- read_rds(paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_quadXorigin.rds"))
save_lambda_obs_extreme2 <- read_rds(paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_extreme2_quadXorigin.rds"))
save_lambda_obs_extreme4 <- read_rds(paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_extreme4_quadXorigin.rds"))
save_lambda_obs_extreme6 <- read_rds(paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_extreme6_quadXorigin.rds"))
save_lambda_obs_extreme2_em <- read_rds(paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_extreme2_em_quadXorigin.rds"))
save_lambda_obs_extreme4_em <- read_rds(paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_extreme4_em_quadXorigin.rds"))
save_lambda_obs_extreme6_em <- read_rds(paste0(path,"/Model_Runs/MPM_output/save_lambda_obs_extreme6_em_quadXorigin.rds"))
# 
...
ggsave(sim_boxplots, filename = "sim_boxplots_quadXorigin.png", width = 10, height = 6)
...
ggsave(contributions_obs_plot, filename = "contributions_obs_plot_quadXorigin.png", width = 13, height = 8)
...
mean_contributions_obs_plot <- ggplot(data = filter(lambdaS_obs_diff_df, Species == "Species Mean" & Scenario != "4 Most Extreme Years")) +
  geom_hline(yintercept = 0, col = "black") +
  geom_linerange(aes(x = Contribution, ymin = fifth, ymax = ninetyfifth, group = Scenario), color = "grey38",position = position_dodge(width = .7), linewidth = .8) +
  geom_linerange(aes(x = Contribution, ymin = twelvepointfive, ymax = eightysevenpointfive, group = Scenario),color = "grey38", position = position_dodge(width = .7), linewidth = 1.5) +
  geom_linerange(aes(x = Contribution, ymin = twentyfifth, ymax = seventyfifth, group = Scenario),color = "grey38", position = position_dodge(width = .7), linewidth = 2.4) +
  
  geom_linerange(aes(x = Contribution, ymin = fifth, ymax = ninetyfifth, color = Scenario),position = position_dodge(width = .7), linewidth = .4) +
  geom_linerange(aes(x = Contribution, ymin = twelvepointfive, ymax = eightysevenpointfive, color = Scenario),position = position_dodge(width = .7), linewidth = 1) +
  geom_linerange(aes(x = Contribution, ymin = twentyfifth, ymax = seventyfifth, color = Scenario),position = position_dodge(width = .7), linewidth = 2) +
...
ggsave(mean_contributions_obs_plot, filename = "mean_contributions_obs_plot_quadXorigin.png", width = 5, height =4)
...
lambdaS_plot
ggsave(lambdaS_plot, filename = "lambdaS_plot_quadXorigin.png", width = 6, height = 10)
